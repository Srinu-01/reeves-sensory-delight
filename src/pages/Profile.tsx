...
import { Calendar, Clock, Users, MapPin, Star, LogOut, Loader2, ArrowLeft, Home } from 'lucide-react';
...
const Profile = () => {
  ...
  // ... keep existing code (suggestions state)
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2 text-sm text-slate-600">
                ...
                <span>/</span>
                <span className="text-amber-600 font-medium">Profile</span>
              </div>
            </div>
          </motion.div>
